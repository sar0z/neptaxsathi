...
export const translations = {
  en: {
    ...
    donations: 'Donations',
    remoteAreaAllowance: 'Remote Area Allowance',
    remoteAreaCategory: 'Remote Area Category',
    categoryA: 'Category A (Rs. 50,000)',
    categoryB: 'Category B (Rs. 40,000)',
    categoryC: 'Category C (Rs. 30,000)',
    categoryD: 'Category D (Rs. 20,000)',
    categoryE: 'Category E (Rs. 10,000)',
    none: 'None',
  ...
  ne: {
    ...
    donations: 'दान',
    remoteAreaAllowance: 'दुर्गम क्षेत्र भत्ता',
    remoteAreaCategory: 'दुर्गम क्षेत्र वर्गीकरण',
    categoryA: 'वर्ग क (रु ५०,०००)',
    categoryB: 'वर्ग ख (रु ४०,०००)',
    categoryC: 'वर्ग ग (रु ३०,०००)',
    categoryD: 'वर्ग घ (रु २०,०००)',
    categoryE: 'वर्ग ङ (रु १०,०००)',
    none: 'छैन',
